    ...
    return (
      <>
        <div class="bar">
          ...
          <div class="acts">
            {c?.update_ready ? <hope-tip text="update cloudflared" pos="bottom-end"><button class="pa upd" disabled={this.busy} onClick={this.update}><loom-icon name="redeploy" size={14}></loom-icon></button></hope-tip> : null}

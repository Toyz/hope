...
LoomIcon.registerAll({
  ...
  "star": '<path d="M11.5 2.7c.2-.5.9-.5 1.1 0l2.4 5 5.3.8c.5.1.7.7.4 1.1l-3.9 3.7.9 5.4c.1.5-.4.9-.9.7l-4.7-2.5-4.7 2.5c-.5.2-1-.2-.9-.7l.9-5.4L2.3 9.6c-.4-.4-.2-1 .4-1.1l5.3-.8z"/>',

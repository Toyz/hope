...
LoomIcon.registerAll({
  ...
  // Computed, not drawn: 10 vertices at 36 degree steps from the top, outer radius 10 and
  // inner 4.8 about (12,12). The old path was hand-plotted and its inner vertices ranged
  // from radius 4.8 to 5.9, which is what made it look lopsided. Corners stay sharp here
  // because the renderer applies stroke-linejoin: round.
  "star": '<path d="M12 2 14.82 8.12 21.51 8.91 16.57 13.48 17.88 20.09 12 16.8 6.12 20.09 7.43 13.48 2.49 8.91 9.18 8.12z"/>',
